...
contract Raffle is VRFConsumerBaseV2Plus{
    ...
    constructor(uint256 entryFee, uint256 interval,address vrfCoordinator, bytes32 gaslane, uint256 subscriptionid , uint32 callbackGasLimit ) VRFConsumerBaseV2Plus(vrfCoordinator) {
        i_entryFee = entryFee;
        i_interval= interval;
